...
/** Volg redirects (o.a. Google grounding-redirects) naar de echte eind-URL. */
export async function resolveFinalUrl(url, { timeoutMs = 12000, retries = 1 } = {}) {
  if (!url) return url;
  // Grounding-redirects lossen niet altijd in één poging op (trage of afwerende
  // doelservers). Eén retry met ruime time-out vangt de meeste stragglers.
