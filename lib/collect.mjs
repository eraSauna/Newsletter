...
{"title":"...","url":"https://... (de echte bron-URL)","source":"naam van de bron","snippet":"korte feitelijke samenvatting","date":"YYYY-MM-DD of null","country":"NL|BE|FR|DE|ES|PT|UK|DK"}.
...
export async function collect({ markets, trendwatch, filterModel, ledger, focus = "" }) {
  const candidates = [];
